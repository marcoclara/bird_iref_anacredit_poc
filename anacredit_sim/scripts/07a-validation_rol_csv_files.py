...
DATA_DIR = "anacredit_sim/output/csv/rol"  # Change if needed

# Define expected values for code lists
VALID_SECTOR_CODES = ['NFC', 'HH', 'GOV']
...
def validate_counterparty():
    ...
    validate_column(df, 'residencycountry', ['PT', 'ES', 'FR', 'DE'], "ROL_Counterparty")  # Example countries
    print("[ROL_Counterparty] Validation complete.\n")

# Validate ROL_Instrument.csv
...
# Validate ROL_InterestRateTerms.csv
